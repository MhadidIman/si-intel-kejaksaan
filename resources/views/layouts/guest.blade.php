...
<body class="font-sans text-slate-900 antialiased bg-[#f8fafc] overflow-hidden">
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 relative z-10 px-4">
        ...
        <div class="mb-8 text-center">
            ...
            <h2 class="mt-6 text-2xl font-black text-slate-800 tracking-tight uppercase">
        ...
        <div class="w-full sm:max-w-md mt-2 px-8 py-10 bg-white shadow-[0_20px_50px_rgba(0,0,0,0.05)] border-2 border-slate-50 overflow-hidden sm:rounded-[2.5rem] relative">
        ...
        <div class="mt-8 text-center">
            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                &copy; {{ date('Y') }} Kejaksaan Negeri. Satya Adhi Wicaksana.
            </p>
        </div>
    </div>
