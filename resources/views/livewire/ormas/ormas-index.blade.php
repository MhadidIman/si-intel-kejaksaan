<div class="py-10 bg-[#f8fafc] min-h-screen font-sans">
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-10 space-y-10">
        ...
        <div class="bg-white rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden w-full">
            ...
            <div class="p-6 border-b border-slate-100 bg-slate-50/50 flex flex-col md:flex-row justify-between items-center gap-4">
                <div class="relative w-full md:max-w-md group">
                    ...
                    <input wire:model.live="search" type="text" class="pl-11 block w-full rounded-xl border-slate-200 bg-white text-slate-800 font-medium focus:border-purple-500 focus:ring-purple-500/20 py-3 shadow-sm text-sm transition-all" placeholder="Cari Nama Organisasi / Pimpinan...">
                </div>
                    ...
                    <tbody class="divide-y divide-slate-100 text-slate-800">
                        ...
                        <tr class="hover:bg-slate-50/80 transition duration-200 group">
                            ...
                            <td class="px-6 py-6 align-top min-w-[250px]">
                                <div class="text-xs text-slate-600 leading-relaxed italic line-clamp-2" title="{{ $item->kegiatan_terakhir }}">
                            ...
                            <td class="px-6 py-6 text-center align-top whitespace-nowrap">
                                <div class="flex justify-center items-center gap-2">
                                    ...
                                    @if(auth()->user()->isAdmin())
                                    <button wire:confirm="Hapus data organisasi ini secara permanen?" wire:click="delete({{ $item->id }})"
        ...
        {{-- ============================================================== --}}
        @if($showForm)
        <div x-transition class="bg-white rounded-[2.5rem] shadow-2xl shadow-purple-600/10 border border-slate-100 overflow-hidden mb-12 relative animate-fade-in-up">
            ...
            <form wire:submit.prevent="{{ $isEditMode ? 'update' : 'store' }}" class="p-8 md:p-10 space-y-8 bg-slate-50/30">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input wire:model="nama_organisasi" type="text" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-purple-500 focus:ring-purple-500/20 transition-all py-3 px-4 shadow-sm placeholder-slate-300 text-sm" placeholder="Masukkan nama lengkap organisasi...">
                    ...
                    <div class="space-y-2">
                        ...
                        <input wire:model="ketua" type="text" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-purple-500 focus:ring-purple-500/20 transition-all py-3 px-4 shadow-sm text-sm" placeholder="Nama pimpinan saat ini...">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <select wire:model="bentuk_organisasi" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-purple-500 focus:ring-purple-500/20 transition-all py-3 px-4 shadow-sm appearance-none text-sm cursor-pointer">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <select wire:model="status" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-purple-500 focus:ring-purple-500/20 transition-all py-3 px-4 shadow-sm appearance-none text-sm cursor-pointer">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-2">
                                ...
                                <input wire:model="nomor_legalitas" type="text" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-purple-500 focus:ring-purple-500/20 transition-all py-3 px-4 shadow-sm text-sm" placeholder="SKT / AHU Kemenkumham">
                            </div>
                            <div class="space-y-2">
                                <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Jumlah Anggota</label>
                                <input wire:model="jumlah_anggota" type="number" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-purple-500 focus:ring-purple-500/20 transition-all py-3 px-4 shadow-sm text-sm" placeholder="Estimasi...">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="space-y-2">
                            ...
                            <input wire:model="kegiatan_terakhir" type="text" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-purple-500 focus:ring-purple-500/20 transition-all py-3 px-4 shadow-sm text-sm" placeholder="Catatan kegiatan terbaru...">
                        </div>
                        <div class="space-y-2">
                            <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Alamat Sekretariat</label>
                            <textarea wire:model="alamat_sekretariat" rows="2" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-medium focus:border-purple-500 focus:ring-purple-500/20 transition-all py-3 px-4 shadow-sm placeholder-slate-300 text-sm leading-relaxed" placeholder="Alamat lengkap markas/sekretariat..."></textarea>
                        </div>
                    </div>
                </div>
