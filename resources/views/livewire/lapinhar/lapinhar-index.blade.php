<div class="py-10 bg-[#f8fafc] min-h-screen font-sans">
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-10 space-y-10">
        ...
        <div class="bg-white rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden w-full">
            ...
            <div class="p-6 border-b border-slate-100 bg-slate-50/50 flex flex-col md:flex-row justify-between items-center gap-4">
                <div class="relative w-full md:max-w-md group">
                    ...
                    <input wire:model.live="search" type="text" class="pl-11 block w-full rounded-xl border-slate-200 bg-white text-slate-800 font-medium focus:border-emerald-500 focus:ring-emerald-500/20 py-3 shadow-sm text-sm transition-all" placeholder="Cari peristiwa atau nomor surat...">
                </div>
        ...
        {{-- ============================================================== --}}
        @if($showForm)
        <div x-transition class="bg-white rounded-[2rem] shadow-2xl shadow-emerald-500/10 border border-slate-100 overflow-hidden mb-12 relative animate-fade-in-up">
            ...
            <form wire:submit.prevent="{{ $isEditMode ? 'update' : 'store' }}" class="p-8 md:p-10 space-y-8 bg-slate-50/30">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input wire:model="nomor_surat" type="text" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-emerald-500 focus:ring-emerald-500/20 transition-all py-3 px-4 shadow-sm placeholder-slate-300 text-sm" placeholder="Contoh: R-01/L.1/Dek.3/12/2025">
                    ...
                    <div class="space-y-2">
                        ...
                        <input wire:model="tanggal_surat" type="date" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-emerald-500 focus:ring-emerald-500/20 transition-all py-3 px-4 shadow-sm text-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <select wire:model="bidang" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-emerald-500 focus:ring-emerald-500/20 transition-all py-3 px-4 shadow-sm appearance-none text-sm cursor-pointer">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <select wire:model="status" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-emerald-500 focus:ring-emerald-500/20 transition-all py-3 px-4 shadow-sm appearance-none text-sm cursor-pointer">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <select wire:model="sumber_informasi" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-emerald-500 focus:ring-emerald-500/20 transition-all py-3 px-4 shadow-sm appearance-none text-sm cursor-pointer">
