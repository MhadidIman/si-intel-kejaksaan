        ...
        <div class="bg-white rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden w-full">
            ...
            <div class="p-6 border-b border-slate-100 bg-slate-50/50 flex flex-col md:flex-row justify-between items-center gap-4">
                <div class="relative w-full md:max-w-md group">
                    ...
                    <input wire:model.live="search" type="text" class="pl-11 block w-full rounded-xl border-slate-200 bg-white text-slate-800 font-medium focus:border-purple-500 focus:ring-purple-500/20 py-3 shadow-sm text-sm transition-all" placeholder="Cari Nama WNA, Kebangsaan atau Paspor...">
                </div>
                        ...
                        <tr class="hover:bg-slate-50/80 transition duration-200 group">
                            ...
                            <td class="px-6 py-6 align-top whitespace-nowrap">
                                ...
                                <div class="text-[10px] text-slate-500 font-bold mt-1.5 uppercase">
                                    <i class="fas fa-id-card text-slate-400 mr-1"></i> Paspor: <span class="text-slate-800 font-mono">{{ $item->nomor_paspor }}</span>
                                </div>
                            ...
                            <td class="px-6 py-6 text-center align-top whitespace-nowrap">
                                <div class="flex justify-center items-center gap-2">
                                    ...
                                    @if(auth()->user()->isAdmin())
                                    <button wire:confirm="Hapus data WNA ini secara permanen?" wire:click="delete({{ $item->id }})"
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="space-y-2 col-span-2">
                            ...
                            <input wire:model="nama_lengkap" type="text" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-purple-500 focus:ring-purple-500/20 transition-all py-3 px-4 shadow-sm placeholder-slate-300 text-sm">
                        ...
                        <div class="space-y-2">
                            ...
                            <input wire:model="kebangsaan" type="text" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-purple-500 focus:ring-purple-500/20 transition-all py-3 px-4 shadow-sm text-sm placeholder-slate-300" placeholder="Contoh: Malaysia">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            <div class="space-y-2">
                                ...
                                <input wire:model="nomor_paspor" type="text" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-purple-500 focus:ring-purple-500/20 transition-all py-3 px-4 shadow-sm text-sm" placeholder="No. Paspor">
                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-2 gap-4">
                                <div class="space-y-2">
                                    ...
                                    <input wire:model="tanggal_tiba" type="date" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-purple-500 focus:ring-purple-500/20 transition-all py-3 px-4 shadow-sm text-sm">
                                </div>
                                <div class="space-y-2">
                                    <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Batas Izin Tinggal</label>
                                    <input wire:model="masa_berlaku_izin_tinggal" type="date" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-purple-500 focus:ring-purple-500/20 transition-all py-3 px-4 shadow-sm text-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <input wire:model="sponsor" type="text" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 font-bold focus:border-purple-500 focus:ring-purple-500/20 transition-all py-3 px-4 shadow-sm placeholder-slate-300 text-sm" placeholder="Nama Perusahaan / Perorangan penjamin">
                            </div>
                        </div>
                        <div class="space-y-2">
