                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        <div class="space-y-2">
                            ...
                            <select wire:model="tingkat_rawan" class="block w-full rounded-xl bg-slate-50 border-2 border-slate-200 text-slate-900 font-bold focus:border-indigo-500 focus:bg-white transition-all py-3 px-4 shadow-sm text-sm">
