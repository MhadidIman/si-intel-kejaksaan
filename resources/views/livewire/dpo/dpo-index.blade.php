<div class="py-10 bg-slate-50 dark:bg-slate-900/50 dark:bg-slate-900 transition-colors duration-300 min-h-screen font-sans">
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-10 space-y-10">
        ...
        <div class="bg-white rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-100 dark:border-slate-700 overflow-hidden w-full">
            ...
            <div class="p-6 border-b border-slate-100 dark:border-slate-700 bg-slate-50/50 flex flex-col md:flex-row justify-between items-center gap-4">
                <div class="relative w-full md:max-w-md group">
                    ...
                    <input wire:model.live="search" type="text" class="pl-11 block w-full rounded-xl border-slate-200 bg-white text-slate-800 dark:text-slate-100 font-medium focus:border-red-500 focus:ring-red-500/20 py-3 shadow-sm text-sm transition-all" placeholder="Cari Nama Buronan atau Kasus...">
                </div>
        ...
        {{-- ============================================================== --}}
        @if($showForm)
        <div x-transition class="bg-white rounded-[2.rem] shadow-2xl shadow-red-600/10 border border-slate-100 dark:border-slate-700 overflow-hidden mb-12 relative animate-fade-in-up">
            ...
            <form wire:submit.prevent="{{ $isEditMode ? 'update' : 'store' }}" class="p-8 md:p-10 space-y-8 bg-slate-50 dark:bg-slate-900/50/30">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input wire:model="nama_lengkap" type="text" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 dark:text-white font-bold focus:border-red-500 focus:ring-red-500/20 transition-all py-3 px-4 shadow-sm placeholder-slate-300 text-sm">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-2">
                            ...
                            <input wire:model="tempat_lahir" type="text" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 dark:text-white font-bold focus:border-red-500 focus:ring-red-500/20 transition-all py-3 px-4 shadow-sm text-sm">
                        </div>
                        <div class="space-y-2">
                            <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Tanggal Lahir</label>
                            <input wire:model="tanggal_lahir" type="date" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 dark:text-white font-bold focus:border-red-500 focus:ring-red-500/20 transition-all py-3 px-4 shadow-sm text-sm">
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <textarea wire:model="kasus" rows="4" class="block w-full rounded-2xl bg-white border border-slate-200 text-slate-900 dark:text-white font-medium focus:border-red-500 focus:ring-red-500/20 transition-all py-4 px-5 shadow-sm placeholder-slate-300 text-sm leading-relaxed" placeholder="Jelaskan ringkasan kasus..."></textarea>
                    ...
                    <div class="space-y-5">
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <select wire:model="status_hukum" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 dark:text-white font-bold focus:border-red-500 focus:ring-red-500/20 transition-all py-3 px-4 shadow-sm appearance-none text-sm cursor-pointer">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <select wire:model="status_pencarian" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 dark:text-white font-bold focus:border-red-500 focus:ring-red-500/20 transition-all py-3 px-4 shadow-sm appearance-none text-sm cursor-pointer">
                        ...
                        <div class="space-y-2">
                            ...
                            <input wire:model="ciri_fisik" type="text" class="block w-full rounded-xl bg-white border border-slate-200 text-slate-900 dark:text-white font-bold focus:border-red-500 focus:ring-red-500/20 transition-all py-3 px-4 shadow-sm placeholder-slate-300 text-sm" placeholder="Contoh: Tinggi 170cm, Tato di lengan, dll">
                        </div>
                    </div>
                </div>
